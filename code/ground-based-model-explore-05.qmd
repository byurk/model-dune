---
title: "ground-based-model-explore-05"
...
We will go through several steps to select predictors for a final XGBoost Model. This is the fifth step, in which we will continue eliminating predictors using variable importance. In step 4 we had a mean cross-validation accuracy of 0.959 (like steps 2-4) with a standard error of 0.00624.

In this step we will eliminate hsv_contrast_L2_W11, resulting in a 14 predictor model.
...
```{r}
model_version = "05" # string used for file names
```
