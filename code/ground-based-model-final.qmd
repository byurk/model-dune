---
title: "ground-based-model-explore-final"
...
We chose the 14-predictor model from step 5 of the predictor selection process. This model had the highest mean cross-validation accuracy (0.959), matching the more complicated models from steps 2-4. Mean accuracy declined in steps 6 and 7. The standard error of was 0.00579 in step 5.
...
```{r}
model_version = "final" # string used for file names
```
