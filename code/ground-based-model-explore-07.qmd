---
title: "ground-based-model-explore-07"
...
We will go through several steps to select predictors for a final XGBoost Model. This is the seventh step, in which we will continue eliminating predictors using variable importance. In step 6 we had a mean cross-validation accuracy of 0.958 (it was 0.959 in steps 2-5) with a standard error of 0.00570.

In this step we will eliminate rgb_seg_SR12_RR4.5_MD70_lab_3, resulting in a 12 predictor model.
...
```{r}
model_version = "07" # string used for file names
```
