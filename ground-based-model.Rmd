...
# if(!file.exists(pixels_path)){
#   message('Data not found')
#   should_extract <- readline(prompt="Would you like to extract the data? (y/n) :")
#   
#   if(should_extract == 'y'){
#     print('this may take a few minutes..')
#     source('src/sample-all-pixels.R')
#   }
#   print(user_input)
# }
...
xgb_recipe  <- recipe(formula_top_features, data = pixels_train) |>
  step_naomit(all_predictors()) |>
  step_novel(all_nominal_predictors()) |>
  step_dummy(all_nominal_predictors()) |>
  step_zv(all_predictors()) |>
